...
description: Apply Implementing DDD for aggregates, domain events, context integration, and application architecture. Use for implementation-focused DDD work or when the user mentions IDDD.
