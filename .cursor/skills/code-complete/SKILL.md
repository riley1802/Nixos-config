---
name: code-complete
description: Apply Code Complete practices for disciplined construction: variables, control flow, defensive programming, and testing. Use for implementation decisions or when the user mentions Code Complete or McConnell.
