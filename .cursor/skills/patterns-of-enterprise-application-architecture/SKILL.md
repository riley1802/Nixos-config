...
description: Apply PoEAA patterns for layers, repositories, domain model, and enterprise integration. Use when choosing application patterns or when the user mentions Fowler patterns or PoEAA.
