---
name: clean-code
description: Apply Clean Code principles for readability, naming, small functions, and maintainable code shape. Use for everyday implementation, code review, or when the user mentions clean code or readability.
