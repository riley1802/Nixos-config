...
description: Apply Domain-Driven Design for domain modeling, bounded contexts, ubiquitous language, and tactical patterns. Use for modeling-heavy work or when the user mentions DDD or Evans.
